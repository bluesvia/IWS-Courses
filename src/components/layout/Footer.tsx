        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-[#15203C] text-[15px] leading-relaxed mb-6">
              {content.footer.description || "A Cambridge-accredited British online school, delivering expert-taught education to students aged 7–19 worldwide."}
            </p>
          ...
          {/* Links */}
          <div>
            <h4 className="font-label font-bold text-xs uppercase tracking-[0.15em] text-[#0A1776] mb-6">Important Links</h4>
            <ul className="space-y-4">
              {content.footer.links.map(link => (
                <li key={link.id}><Link to={link.url} className="text-[15px] text-[#15203C] hover:text-[#0067E0] transition">{link.label}</Link></li>
              ))}
            </ul>
          </div>
